...
To apply the patch of https://github.com/int128/kubebuilder-updates/pull/374/commits/c464e1cf6c27e77a9e7c8f37e8c3c1c683f3d349,

```sh
# Fetch the diff
git fetch https://github.com/int128/kubebuilder-updates c464e1cf6c27e77a9e7c8f37e8c3c1c683f3d349

# Apply the patch
git checkout -b update-kubebuilder-v4.14.0
git cherry-pick c464e1cf6c27e77a9e7c8f37e8c3c1c683f3d349
```

You may need to resolve conflicts.

```sh
git commit -m 'Update kubebuilder from v4.13.1 to v4.14.0'
gh pr create -f
```

<!-- kubebuilder v4.13.1 -->
### Update kubebuilder from v4.13.0 to v4.13.1

To apply the patch of https://github.com/int128/kubebuilder-updates/pull/333/commits/d6e30ff42335d40c78c899343fa0da9535a50ed1,

```sh
# Fetch the diff
git fetch https://github.com/int128/kubebuilder-updates d6e30ff42335d40c78c899343fa0da9535a50ed1

# Apply the patch
git checkout -b update-kubebuilder-v4.13.1
git cherry-pick d6e30ff42335d40c78c899343fa0da9535a50ed1
```

You may need to resolve conflicts.

```sh
git commit -m 'Update kubebuilder from v4.13.0 to v4.13.1'
gh pr create -f
```

<!-- kubebuilder v4.13.0 -->
### Update kubebuilder from v4.12.0 to v4.13.0

To apply the patch of https://github.com/int128/kubebuilder-updates/pull/302/commits/d1c3612f66770f819d1ad7661020f68b4ac54c0f,

```sh
# Fetch the diff
git fetch https://github.com/int128/kubebuilder-updates d1c3612f66770f819d1ad7661020f68b4ac54c0f

# Apply the patch
git checkout -b update-kubebuilder-v4.13.0
git cherry-pick d1c3612f66770f819d1ad7661020f68b4ac54c0f
```

You may need to resolve conflicts.

```sh
git commit -m 'Update kubebuilder from v4.12.0 to v4.13.0'
gh pr create -f
```
...
To apply the patch of https://github.com/int128/kubebuilder-updates/pull/272/commits/656183088b510ed006e809814ac7d5bab45bc9eb,

```sh
# Fetch the diff
git fetch https://github.com/int128/kubebuilder-updates 656183088b510ed006e809814ac7d5bab45bc9eb

# Apply the patch
git checkout -b update-kubebuilder-v4.11.1
git cherry-pick 656183088b510ed006e809814ac7d5bab45bc9eb
```

You may need to resolve conflicts.

```sh
git commit -m 'Update kubebuilder from v4.11.0 to v4.11.1'
gh pr create -f
```

<!-- kubebuilder v4.11.0 -->
### Update kubebuilder from v4.10.1 to v4.11.0

To apply the patch of https://github.com/int128/kubebuilder-updates/pull/270/commits/82542dfa93d00351e59b30a8825f6a38dd7208f2,

```sh
# Fetch the diff
git fetch https://github.com/int128/kubebuilder-updates 82542dfa93d00351e59b30a8825f6a38dd7208f2

# Apply the patch
git checkout -b update-kubebuilder-v4.11.0
git cherry-pick 82542dfa93d00351e59b30a8825f6a38dd7208f2
```

You may need to resolve conflicts.

```sh
git commit -m 'Update kubebuilder from v4.10.1 to v4.11.0'
gh pr create -f
```

<!-- kubebuilder v4.10.1 -->
### Update kubebuilder from v4.9.0 to v4.10.1

To apply the patch of https://github.com/int128/kubebuilder-updates/pull/237/commits/7bbd0bec29994693280a9ec131743679f7955d5f,

```sh
# Fetch the diff
git fetch https://github.com/int128/kubebuilder-updates 7bbd0bec29994693280a9ec131743679f7955d5f

# Apply the patch
git checkout -b update-kubebuilder-v4.10.1
git cherry-pick 7bbd0bec29994693280a9ec131743679f7955d5f
```

You may need to resolve conflicts.

```sh
git commit -m 'Update kubebuilder from v4.9.0 to v4.10.1'
gh pr create -f
```
