...
This repository contains the scaffold code generated by [kubebuilder](https://github.com/kubernetes-sigs/kubebuilder).
It is continuously updated by Renovate and [GitHub Actions](.github/workflows/scaffold.yaml).

## How to update your project

You can update your project using the patch in this repository.
